...
def new_game(message):
    start_massage='Бот @gia9_inf_bot версии'+config.ver+'\n'
    start_massage1='''Предназначен для тренировки навыков умственного труда и алгоритмов решения заданий ГИА по информатике.
