...
def start_game(message):
    ...
    bot.send_message(message.chat.id,'<b>Вот какие команды я знаю<b/>\n',parse_mode='HTML')
    ...
    '/1 - получить задание номер 1\n'
    '/2 - получить задание номер 2\n'
    '/3 - получить задание номер 3\n'
    '/4 - получить задание номер 4\n'
    '/5 - получить задание номер 5\n'
    '/6 - получить задание номер 6\n'
    '/7 - получить задание номер 7\n'
    '/8 - получить задание номер 8\n'
    '/9 - получить задание номер 9\n'
    '/10 - получить задание номер 10\n'
    '/11 - получить задание номер 11\n'
    '/12 - получить задание номер 12\n'
